...
// Handler exports
export { createAllHandlers, createFlatHandlerMap, createAssistantHandlers, createThreadHandlers, createMessageHandlers, createRunHandlers, createRunStepHandlers, HANDLER_CATEGORIES, TOTAL_TOOL_COUNT, validateHandlerCompleteness } from './handlers/index.js';
 ...
 */
export function setupHandlerSystem(context) {
    const registry = new ToolRegistry(context);
    const handlers = createFlatHandlerMap(context);
