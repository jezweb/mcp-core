/**
 * Tool Definitions Generator - Generates MCP tool definitions from handlers
 * 
 * This module provides functionality to dynamically generate tool definitions
 * from the modular handler system, ensuring consistency between tool execution
